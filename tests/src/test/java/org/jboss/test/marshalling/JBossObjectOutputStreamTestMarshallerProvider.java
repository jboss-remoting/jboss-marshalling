 ...
 *
 */
public final class JBossObjectOutputStreamTestMarshallerProvider implements TestMarshallerProvider {
...
//            config.getCreator() != null ||
      ...
      final JBossObjectOutputStreamSharedTree ois = new JBossObjectOutputStreamSharedTree(Marshalling.createOutputStream(target));
      return new JBossObjectOutputStreamMarshaller(ois);
   }
}