...
//        }
    ...
    public void testEmptyArray() throws Throwable {
        runReadWriteTest(new ReadWriteTest() {
            ...
            public void runRead(final Unmarshaller unmarshaller) throws Throwable {
                final SerializableWithFinalFields[] array = (SerializableWithFinalFields[]) unmarshaller.readObject();
                assertNotNull(array);
    ...
    public void testEmptyArrayInObject() throws Throwable {
        runReadWriteTest(new ReadWriteTest() {
            ...
            public void runRead(final Unmarshaller unmarshaller) throws Throwable {
                final SerializableWithFinalFields[] array = ((ArrayHolder)unmarshaller.readObject()).getArray();
                assertNotNull(array);
                assertTrue(Arrays.equals(new SerializableWithFinalFields[0], array));
            }
        });
